...
use PersonalizeAI\FotoAnalyzeTool\Model\TagProcessor; // New service class for processing tags
...
class SaveBetaFaceData extends Action
{
    ...
    protected $tagProcessor; // New dependency
    protected $logger; // Logger for error handling
     ...
     * @param TagProcessor $tagProcessor // Injecting the tag processor
     * @param LoggerInterface $logger // Injecting logger for error handling
     */
    public function __construct(
        ...
        $this->tagProcessor = $tagProcessor; // Initialize tag processor
